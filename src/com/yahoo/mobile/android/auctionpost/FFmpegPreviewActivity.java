...
public class FFmpegPreviewActivity extends Activity implements TextureView.SurfaceTextureListener, OnClickListener, OnCompletionListener {
    ...
    private ImageButton cancelBtn, nextBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancelBtn = (ImageButton)findViewById(R.id.btn_play_cancel);
        cancelBtn.setOnClickListener(this);
        nextBtn = (ImageButton)findViewById(R.id.btn_play_next);
    ...
    public void onClick(View v) {
        ...
        case R.id.btn_play_next:
            Intent intent = new Intent(FFmpegPreviewActivity.this, MediaDecorateActivity.class);
