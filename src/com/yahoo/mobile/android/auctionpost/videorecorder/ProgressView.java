...
public class ProgressView extends View {
    ...
    private float firstWidth = 8f, threeWidth = 1f;// �ϵ�Ŀ��
    private LinkedList<Integer> linkedList = new LinkedList<Integer>();
    private float perPixel = 0l;
    private float countRecorderTime = FFmpegRecorderActivity.recordingTime;// �ܵ�¼��ʱ��
    ...
    private void init(Context paramContext) {
        ...
        progressPaint.setColor(getResources().getColor(R.color.action_bar_background));

        // һ��һ���Ļ�ɫ���
        firstPaint.setStyle(Paint.Style.FILL);
        firstPaint.setColor(getResources().getColor(R.color.action_bar_background));
//        firstPaint.setColor(Color.parseColor("#ffcc42"));

        // 3�봦�Ľ��
        threePaint.setStyle(Paint.Style.FILL);
        threePaint.setColor(Color.TRANSPARENT);
