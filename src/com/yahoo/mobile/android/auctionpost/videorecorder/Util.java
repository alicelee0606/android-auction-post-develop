...
public class Util {
    ...
    public static void showDialog(Context context, String title, String content, int type, final Handler handler) {
        ...
        Button confirmButton = (Button)view.findViewById(R.id.setting_account_bind_confirm);// 确认
        Button cancelButton = (Button)view.findViewById(R.id.setting_account_bind_cancel);// 取消
